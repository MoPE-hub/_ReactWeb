  ...
  return (
    <React.Fragment>
      ...
      <div className="modal-extension p-t-0 p-l-10 p-r-10 p-b-10">
        ...
        <input type="radio" id="slider-7" name="slider" title="slide-7" className="slider-nav" />
        ...
        <div className="slider">
          <div className="slider-inner">
            ...
            <div className="slider-contents">
              <h5 className="component light-gray">계약명을 입력하세요</h5>
            ...
            <div className="slider-contents">
              <h5 className="component light-gray">계약서를 업로드하세요</h5>
            ...
            <div className="slider-contents">
              <h5 className="component light-gray">일괄계약 템플릿을 업로드하세요</h5>

              <div className="content">
                <div className="input-with-btn m-b-5">
                  <input
                    type="file"
                    id="pkgFile"
                    name="pkgFile"
                  ...
                  <span className="text">
                    <label htmlFor="pkgFile">
                      {
                        state.pkgFile ? state.pkgFile[0].name : "템플릿 첨부"
                      }
                    </label>
                  </span>
                </div>
                ...
                <div
                  className="description dis-block"
                  onClick={() => handleDownload('../files/pkgTemplate.xlsx')}
                >
                  템플릿 파일을 업로드 합니다. [xls, xlsx]
                  <a href="#"><span className="text-underline">일괄계약 템플릿 다운로드</span></a>
                </div>
              </div>
            </div>
            ...
            <div className="slider-contents">
              ...
              <div className="content">
                <div className="dis-block p-b-20">
                  <input type="radio" id="signCertTypeA" className="radio-button" value="A" name="signCertType" defaultChecked={true} />
                  <label htmlFor="signCertTypeA">
                    공인인증서
                  </label>
                  <input type="radio" id="signCertTypeB" className="radio-button" value="B" name="signCertType" />
        ...
        <div className="dialog-button flex-c-m">
          ...
          <label
            htmlFor="slider-4"
            className={`slider-control next control-3 btn btn-dark-gray btn-md ${!state.generalFile ? 'disabled' : ''}`}
          >
            다음
          </label>
          ...
          <label
            htmlFor="slider-5"
            className={`slider-control next control-4 btn btn-dark-gray btn-md ${!state.pkgFile ? 'disabled' : ''}`}
          >
            다음
          </label>
          ...
          <label
            htmlFor="slider-6"
            className={`slider-control next control-5 btn btn-dark-gray btn-md ${!state.cntrctMax ? 'disabled' : ''}`}
          >
            다음
          </label>

          <label htmlFor="slider-5" className="slider-control prev control-6 btn btn-white btn-md m-r-10">뒤로</label>
          <label htmlFor="slider-7" className="slider-control next control-6 btn btn-dark-gray btn-md">다음</label>

          <label htmlFor="slider-6" className="slider-control prev control-7 btn btn-white btn-md m-r-10">뒤로</label>
          <label htmlFor=""
            className="slider-control next control-7 btn btn-red btn-md"
